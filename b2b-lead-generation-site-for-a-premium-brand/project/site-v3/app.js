...
(function () {
  ...
  const COPY = {
    en: {
      ...
      'origin.p1': 'Dagua valley has been a place of belonging for the Ebright family for decades. The spring-fed swimming hole on their land became a gathering place for the local community long before anyone thought to bottle what came out of the ground.',
      ...
      'origin.p3': 'With the cultivation, nurturing and support of Mr. Resanovic, premiumwater is a spring water company born from the same source — committed to the same valley.',
      'origin.p4': 'Every bottle carries the story of this land and the people who have cared for it. premiumwater is built to give back — through jobs for the people of Dagua and Borrero Ayerbe, support for the communities along the Loboguerrero corridor, and charitable work that reflects what this spring has always represented.',
      'origin.tagline': 'The Ebright family didn\'t just find this land. They became part of it.',
    ...
    es: {
      ...
      'origin.p1': 'El valle del Dagua ha sido un lugar de pertenencia para la familia Ebright durante décadas. La piscina natural alimentada por manantial en sus tierras se convirtió en un punto de encuentro para la comunidad local mucho antes de que alguien pensara en embotellar lo que brotaba del suelo.',
      'origin.p2': 'El señor Ebright, hoy de 72 años, construyó su vida alrededor de esta tierra y la gente que llama hogar a Dagua. Sus hijos continúan ese legado, comprometidos con honrar lo que su padre construyó.',
      'origin.p3': 'Con el cultivo, cuidado y apoyo del señor Resanovic, premiumwater es una compañía de agua de manantial nacida en la misma fuente — comprometida con el mismo valle.',
      'origin.p4': 'Cada botella lleva la historia de esta tierra y la gente que la ha cuidado. premiumwater está hecha para devolver: a través del empleo para la gente de Dagua y Borrero Ayerbe, del apoyo a las comunidades del corredor Loboguerrero, y de la obra benéfica que refleja lo que este manantial siempre ha representado.',
      'origin.tagline': 'La familia Ebright no solo encontró esta tierra. Se hizo parte de ella.',
  ...
  const BOLD_COPY = {
    en: {
      ...
      'origin.eyebrow': '05 · The valley',
      'origin.hed': 'Dagua,<br/><em>always.</em>',
      'origin.lede': 'Same spring. Same family. Same dirt this water has run through for decades.',
      'origin.p1': 'Mr. Ebright bought this stretch of the Dagua valley decades ago. The spring on his land became a swimming hole, then a meeting place for the whole community.',
      'origin.p2': 'His kids run the place now. We work with them. Every bottle goes back into Dagua, Borrero Ayerbe, and the Loboguerrero corridor — jobs, schools, water access.',
      'origin.p3': '',
      'origin.p4': '',
      'origin.tagline': 'We didn\'t find this water. We grew up in it.',
    ...
    es: {
      ...
      'origin.eyebrow': '05 · El valle',
      'origin.hed': 'Dagua,<br/><em>siempre.</em>',
      'origin.lede': 'Mismo manantial. Misma familia. Misma tierra por la que ha corrido esta agua durante décadas.',
      'origin.p1': 'El señor Ebright compró esta franja del valle del Dagua hace décadas. El manantial de su tierra se convirtió en balneario, luego en punto de encuentro para toda la comunidad.',
      'origin.p2': 'Sus hijos manejan el lugar ahora. Trabajamos con ellos. Cada botella regresa a Dagua, Borrero Ayerbe y el corredor Loboguerrero — empleos, escuelas, acceso al agua.',
      'origin.p3': '',
      'origin.p4': '',
      'origin.tagline': 'No encontramos esta agua. Crecimos con ella.',
